...
async function displayTasks() {
    ...
    tasks.forEach((task, index) => {
      ...
      deleteButton.innerHTML = '<i class="fa-solid fa-delete-left" style="color: #ed333b;"></i>'; // Use a solid left arrow icon
...
async function displayNotes() {
    ...
    notes.forEach((note, index) => {
      ...
      deleteButton.innerHTML = '<i class="fa-solid fa-delete-left" style="color: #ed333b;"></i>"></i>'; // Use a solid left arrow icon
